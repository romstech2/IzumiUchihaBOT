#this file was originated from Astrako/Astrakobot and modified, all rights reserved
#Modified by AbOuLfOoOoOuF
...
from telegram import TelegramError, Update, Message, Chat, Bot
